...
new_card = '''
  ...
  <div class="portal-card-icon" style="background: rgba(139, 92, 246, 0.1); color: #8b5cf6; border-radius: 10px; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
  ...
  <a class="portal-card-btn" href="links.html" style="font-weight: 700; border: none; cursor: pointer; display: block; text-decoration: none; width: 100%; text-align: center; border-radius: 8px; padding: 12px; box-sizing: border-box; background: var(--primary-color); color: white;">📚 Μετάβαση στο Υλικό</a>
  </div>
  </section>'''

html = re.sub(r'(<a class="portal-card-btn clinical-btn" href="cases\.html".*?</a>\s*</div>\s*)</section>', r'\1' + new_card, html, flags=re.DOTALL)
